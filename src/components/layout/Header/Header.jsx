...
export default class Home extends Component{
    ...
    render(){
        return (
            <div className = 'cont' style = {{backgroundColor: this.props.bg}}>
                <main className = 'mainer'>
            <header className="header" style = {{backgroundColor: this.props.bg, justifyContent: 'flex-start', flexDirection: 'row'}}>
                <div className="icon">
                  <div className="nav-icon" onClick = {this.props.toggle}>
                        <span className="nav-icon__line top"></span>
                        <span className="nav-icon__line middle"></span>
                        <span className="nav-icon__line bottom"></span>
                  </div>
                </div>
                <div className="wrap">
                ...
                <h1 className = 'header__title' style = {{color: this.props.color}}>AVC STEM</h1>
                </div>
            
                {(this.state.token !== null || localStorage.getItem('token') !== null) ?
                  <button className='loginBtn' style = {{color: this.props.color}} onClick = {() => {
                        console.log(this.state.token)
                        localStorage.clear()
                        this.setState({
                              token: null
                        ...
                        }>Ելք</button> :  <Popup className = 'modalCT' trigger={<button style = {{color: this.props.color}} className='loginBtn'>Մուտք</button>} modal>
                        {close => (
                          <div className="modal">
                            ...
                            <div className="content">
                              ...
                              <form className='login-form' onSubmit={this.makeLoginRequest}>
                                     <input className = 'login-form__inp' type="text" name="username" onChange={(text) => this.setState({ text: text.target.value })} value={this.state.text} placeholder='Մուտքանուն'/>
                                    <input className = 'login-form__inp' type="password" name="password" onChange={(password) => this.setState({ password: password.target.value })} value={this.state.password} placeholder='Գաղտնաբառ'/>
                                    <input class = "button" type="submit" onClick = {console.log('success')} value="Հաստատել" />
                              </form>
                            </div>
                          </div>
                        )}
